// js/data/drapingColors.js - 전문가 드래이핑용 색상 데이터
...
// 전문가 드래이핑 가이드
const EXPERT_DRAPING_GUIDE = {
    preparation: {
        title: '드래이핑 준비사항',
        lighting: {
            standard: 'D50 (5003K)',
            cri: 'CRI ≥ 90, R9 ≥ 70',
            intensity: '1000-1500 lux',
            uniformity: '균등 확산'
        },
        environment: {
            temperature: '20±2℃',
        ...
        fabric: {
            size: '30×49cm (Sci\\ART 표준)',
            material: '100% 천연섬유',
            finish: '무광택',
            accuracy: 'Munsell ±0.5 허용'
        }
    },
    observation: {
        timing: {
    ...
    quality: {
        accuracy: '92-97% 목표',
        consistency: '85% 이상 일치율',
        reproducibility: '90% 이상 재현율',
        validation: 'Cohen\'s Kappa > 0.8'
    }
};
...
if (typeof window !== 'undefined') {
    ...
    window.EXPERT_DRAPING_GUIDE = EXPERT_DRAPING_GUIDE;
}
